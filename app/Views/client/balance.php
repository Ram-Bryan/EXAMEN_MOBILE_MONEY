...
<div class="mb-4">
    <h2 class="fw-bold" style="color: var(--text-dark);"><i class="fas fa-wallet text-green"></i> Mon Solde</h2>
...
<div class="row">
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm text-center p-5" style="border-radius: 16px;">
            ...
            <h3 class="text-muted text-uppercase mb-2" style="font-size: 14px; font-weight: 600; letter-spacing: 1px;">Solde Actuel</h3>
            <div class="mb-4 text-green" style="font-size: 48px; font-weight: 800;">
                <?= number_format($balance, 0, ',', ' ') ?> Ar
            </div>

            <div class="d-grid gap-2">
                <button class="btn btn-green btn-lg" onclick="refreshBalance()">
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                <h5 class="fw-bold mb-0">Informations du compte</h5>
            </div>
            <div class="card-body p-4">
                <div class="d-flex justify-content-between border-bottom py-3">
                    <span class="text-muted">Numéro de téléphone :</span>
                    <span class="fw-bold"><?= esc($phone) ?></span>
                </div>
                <div class="d-flex justify-content-between border-bottom py-3">
                ...
                <div class="d-flex justify-content-between py-3">
                    ...
                    <span class="badge bg-green px-3 py-2"><?= esc($operator_prefix) ?></span>
                </div>
            </div>
        </div>
    </div>
